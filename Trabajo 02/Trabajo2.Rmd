...
Debido a que las estimaciones estan por encima de la curva teórica, se puede pensar que se trata de un proceso de agregación.
...
Cómo las curvas estimadas estan por debajo de la curva teórica (Azul) se supone que es un patrón de agregación.
...
Como las funciones estimadas para la G están por encima de la teórica se presume que el patrón es de agración.
...
Debido a que las estimaciones se alejan por arriba de la teórica en distancias pequeñas se puede asumir que la hipótesis del patrón puntual es de agregación.
