...
fryplot(FiresCA2017_ppp, main = "Gráfico de Fry")
```

Al realizar el gráfico de Patterson se observa que todos los puntos se distribuyen homogéneamente de manera aleatoria, por ello se presume aleatoriedad completa.
